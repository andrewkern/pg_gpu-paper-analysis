...
Mirrored from ``pg_gpu/examples/scikit_allel_comparison.py``. The
...
Produces:
  - 01_accuracy/figures/scikit_allel_comparison.pdf

External data:
  - /home/adkern/pg_gpu/examples/data/gamb.X.phased.n100.zarr           (full)
  - /home/adkern/pg_gpu/examples/data/gamb.X.8-12Mb.n100.derived.zarr   (--small)

Usage
-----
    python 01_accuracy/scripts/scikit_allel_comparison.py
    python 01_accuracy/scripts/scikit_allel_comparison.py --small
    python 01_accuracy/scripts/scikit_allel_comparison.py --no-plot
"""
...
# Data fixtures live with the upstream pg_gpu repo. The full
# X-chromosome (~25 Mb, 5.3M variants) is the default; --small picks
# a 4 Mb subset for fast iteration during development.
DATA_DIR = Path("/home/adkern/pg_gpu/examples/data")
...
def _parse_args():
    ...
    p.add_argument("-o", "--output", type=Path,
                   default=Path(OUT_DIR_FIG) / "scikit_allel_comparison.pdf",
