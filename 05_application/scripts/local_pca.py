...
Mirrored from ``pg_gpu/examples/local_pca.py``. The upstream is the
canonical example; this in-repo copy keeps the paper figure
regeneration tied to this repo's commit graph.
...
Produces:
  - 05_application/figures/local_pca.png

Usage
-----
    python 05_application/scripts/local_pca.py
    python 05_application/scripts/local_pca.py --seed 7 --window 150
    python 05_application/scripts/local_pca.py --no-plot
"""
...
def main() -> None:
    ...
    p.add_argument("--out", type=pathlib.Path,
                   default=pathlib.Path("05_application/figures/local_pca.png"))
